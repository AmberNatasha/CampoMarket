...
public sealed class PedidosController(IOrderService pedidos) : Controller
{
    [HttpGet("/pedidos")]
    public IActionResult Index() => View(pedidos.PedidosCliente(UserId()));
    ...
    {
        var result = pedidos.CancelOrder(UserId(), id);
